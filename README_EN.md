...
graph TB
    ...
    subgraph Electron["Electron Desktop Shell"]
        ...
        BackendMgr[Backend Process Manager]
    end
    ...
    subgraph Backend["Backend (FastAPI)"]
        ...
        Logger[Logging PII Anonymizer]
    end

    subgraph WorkflowEngine["LangGraph Workflow Engine"]
        TopicSub[Topic Selection Subgraph]
        Retrieve[RAG Retrieval]
        Write[Article Writing]
        Evaluate[Quality Evaluation]
        Review[Human Review]
        Visuals[Visual Points Extraction]
        Images[Image Generation]
    end

    subgraph External["External Services"]
        LLM[Doubao LLM]
        Embed[SiliconFlow Embedding]
        ImgGen[Gemini Image Generation]
